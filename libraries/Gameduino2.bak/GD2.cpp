...
//CHANGE THIS FOR SD PINS (HAS BEEN CHANGED FOR ARUDINO AT NEWHAVEN
#if defined(ESP8266)
#define SD_PIN        D9    // pin used for the microSD enable signal
#else
//#define SD_PIN        9     // pin used for the microSD enable signal
#define SD_PIN        5     // (for NHD EVE TFTs pin used for the microSD enable signal
#endif

//CHANGE THESE FOR THE BOARD BEING USED
#define BOARD_FTDI_80x    1	  //Default WAS false (FDTI 80X) was not selected)
#define BOARD_GAMEDUINO23 0   //Default WAS True (Gameduino board was selected as default but no longer)


//#define BOARD       BOARD_GAMEDUINO23 // board, from above - DEFAULT
#define BOARD         BOARD_FTDI_80x 	// board, from above being selected again
...
//NOT SURE - but has to do with drawing
...
//Initialization for Gameduino board
...
//Calibrate touchscreen
	...
	//TO CALIBRATE, SET TO 0x00.  
	//Once calibarted, frimware for calibration is non-volatile. 
	//So it can be set back to default 0x7C
