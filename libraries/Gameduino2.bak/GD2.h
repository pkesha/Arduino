...
//ASPI is an interface that standardizes comms on PC bus and SCSI driver
class ASPI_t {
public:
  void begin(void) {
    pinMode(MOSI, OUTPUT);
...
//For the SD CARD initialization
class sdcard {
  public:
  void sel() {
