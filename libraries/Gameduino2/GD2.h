...
#if defined(ESP8266)
#define SD_PIN        D5    // pin used for the microSD enable signal org: D9
#elif defined(ARDUINO_ARCH_STM32)
#define SD_PIN        PB5	//Org PB1
#else
#define SD_PIN        5     // pin used for the microSD enable signal org: 9
#endif					
...
#ifndef DEFAULT_CS
#if defined(ESP8266)
#define DEFAULT_CS D10	//Org 10
#elif defined(ARDUINO_ARCH_STM32)
#define DEFAULT_CS PB10	//Org PB0
#elif (BOARD == BOARD_SUNFLOWER)
#define DEFAULT_CS 10	//Org 6
#else
#define DEFAULT_CS 10	//Org 8
#endif
#endif
